...
class AD5933s {
    public:
		...
		// Temporary data (DFT-Results):
		int16_t tempRealData;
		int16_t tempImagData;
		...
		static bool setSettlingTimeCycles(unsigned int);
		...
		static bool beginOneFrequency();
		
        // Perform endless single frequency measures:
        bool getOneFrequency(int* real = nullptr, int* imag = nullptr);
		/*bool getOneFrequency(float* magnitude = nullptr);*/
		
		// Begin performing endless single frequency measures:
		static bool endOneFrequency();
