...
class ADG1606{
	...
	public:
		...
		// Constructor:
		ADG1606(int _s0, int _s1, int _s2, int _s3, int _en, Adafruit_MCP23017* _mcp, int electAssignment[ELECTRODE_NUMBER]);
		
		// Initialize (set Initial conditions of GPIO (Mode & Value @ MCP23017) )
		void init_ADG1606();
	
		// Switch to Channel (slow):
		void channel(int _channel);
	...
	private:
		...
		Adafruit_MCP23017* mcp;			// MCP23017-Object to which the MUX is connected
